...
class GeoQuery {
    ...
    fun whereNearToLocation(
        ...
        val queryLocation =
            QueryLocation.fromDegrees(centerLocation.latitude, centerLocation.longitude)
    ...
    //distribute the snapshot lists

    fun addSnapshotListener(snapshotListener: (FirebaseFirestoreException?, MutableList<DocumentSnapshot>, MutableList<DocumentSnapshot>, MutableList<DocumentSnapshot>) -> Unit) {
        this.queryListener =
            query.addSnapshotListener { querySnapshot, firebaseFirestoreException ->
    ...
    fun addSnapshotListener(snapshotListener: GeoQueryEventListener, getAllLists: Boolean) {
        addSnapshotListener { firebaseFirestoreException, addedList, modifiedList, removeList ->
            snapshotListener.onEvent(firebaseFirestoreException, addedList, modifiedList, removeList)
        }
    }
